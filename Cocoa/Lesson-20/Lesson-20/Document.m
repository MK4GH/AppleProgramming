...
@synthesize assignements;

- (id)init {
    self = [super init];
    if (self) {
      // Add your subclass-specific initialization here.
      assignements = [[NSMutableArray alloc] init];
    }
    return self;
}
...
- (NSData *)dataOfType:(NSString *)typeName 
  ...
  // specified type. If outError != NULL, ensure that
  // you create and set an appropriate error when returning nil.
...
- (BOOL)readFromData:(NSData *)data 
  ...
  // data of the specified type. If outError != NULL, 
  // ensure that you create and set an appropriate error 
  // when returning NO.
